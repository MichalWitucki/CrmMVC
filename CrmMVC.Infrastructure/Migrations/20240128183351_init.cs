        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContactPeople_PersonRoles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TenderText = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    IssuingAgencyId = table.Column<int>(type: "int", nullable: true),
                    EngineeringOfficeId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Projects_Companies_EngineeringOfficeId",
                        column: x => x.EngineeringOfficeId,
                        principalTable: "Companies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Projects_Companies_IssuingAgencyId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Projects_Voivodeships_VoivodeshipId",
                        column: x => x.VoivodeshipId,
                        principalTable: "Voivodeships",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CatalogueNumber = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UnitId = table.Column<int>(type: "int", nullable: false),
                    WeightPerUnitInKg = table.Column<double>(type: "float", nullable: false),
                    DiameterId = table.Column<int>(type: "int", nullable: false),
                    IsPipe = table.Column<bool>(type: "bit", nullable: false),
                    IsOfferItem = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_ProductDiameters_DiameterId",
                        column: x => x.DiameterId,
                        principalTable: "ProductDiameters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactPeople_RoleId",
                table: "ContactPeople",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_Products_DiameterId",
                table: "Products",
                column: "DiameterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_EngineeringOfficeId",
                table: "Projects",
                column: "EngineeringOfficeId");

            migrationBuilder.CreateIndex(
                name: "IX_Projects_IssuingAgencyId",
                table: "Projects",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_VoivodeshipId",
                table: "Projects",
                column: "VoivodeshipId");
        }
